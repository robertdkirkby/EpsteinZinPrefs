...
% Traditional EZ in consumption-units with endogenous labor
...
% Specifically, we are doing traditional EZ with endogenous labor
vfoptions.EZutils=0;

% 2. Set the appropriate preference parameters.
% Epstein-Zin preference parameters
vfoptions.EZriskaversion='gamma'; % Name of the relative risk aversion parameter
Params.gamma=2; % Risk aversion
vfoptions.EZeis='psi'; % Name of the EIS parameter
Params.psi=0.5; % Elasticity of Intertemporal Substitution (IES)
...
% Discount rate
Params.beta = 0.96;
% Note that gamma and psi are set above as part of Epstein-Zin preferences
...
Params.wg=0; % (relative) importance of bequests
...
% Traditional consumption-unit EZ requires different setup of return fn
ReturnFn=@(h,aprime,a,z,w,chi,agej,Jr,pension,r,kappa_j) ...
    LifeCycleModel12traditional2_ReturnFn(h,aprime,a,z,w,agej,Jr,pension,r,kappa_j,chi)
