%% Life-Cycle Model 12: exog labor version
% Use Epstein-Zin with CES utility function
...
vfoptions.EZutils=1; % Use Epstein-Zin with a utility function
vfoptions.EZpositiveutility=0; % The codes for EZ prefs with a utility function depend on the sign of the utility function
% This is also important for the interpretation of the risk aversion parameter

% 2. Set the appropriate preference parameters.
% Epstein-Zin preference parameters
vfoptions.EZriskaversion='phi'; % Name of the (inverse) risk aversion parameter
Params.phi=0; % (Inverse) Risk aversion
% Because we use a negative-valued utility function a higher value of
% EZriskaversion relates to lower levels of risk aversion (EZriskaversion<0 is risk averse)
...
% Still use 'LifeCycleModel12exo_ReturnFn'
ReturnFn=@(aprime,a,z,w,agej,Jr,pension,r,kappa_j,gamma) ...
    LifeCycleModel12exo_ReturnFn(aprime,a,z,w,agej,Jr,pension,r,kappa_j,gamma)

%% Now solve the value function iteration problem, just to check that things are working before we go to General Equilbrium
disp('Test ValueFnIter')
% vfoptions=struct(); % Just using the defaults.
tic;
Params.sj=ones(N_j,1);
