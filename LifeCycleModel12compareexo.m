...
% vNM version which we should get the same answer as
...
% Use 'LifeCycleModel12exo_ReturnFn'
ReturnFn=@(aprime,a,z,w,agej,Jr,pension,r,kappa_j,gamma) ...
    LifeCycleModel12exo_ReturnFn(aprime,a,z,w,agej,Jr,pension,r,kappa_j,gamma) % NOTE: can just reuse the exo return fn, no need for another one specific to compareexo
