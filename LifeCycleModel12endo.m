...
Params.beta = 0.96;
Params.gamma=2;
Params.chi=0.6; % Weight on leisure. This has not been seriously calibrated
...
% Use 'LifeCycleModel12_ReturnFn'
ReturnFn=@(h,aprime,a,z,w,chi,agej,Jr,pension,r,kappa_j,gamma) ...
    LifeCycleModel12_ReturnFn(h,aprime,a,z,w,chi,agej,Jr,pension,r,kappa_j,gamma)
